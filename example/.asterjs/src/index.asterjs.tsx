...
import _A_S_styles from "./index.asterjs.module.scss";
...
<section class={_A_S_styles["_A_4"]}>{" "}
{() => {
let _A_ElementsArray: JSX.Element[] = [];
let $counter = _A_createSignalVar((() => { let $counter: number = 10; return $counter; })());
_A_ElementsArray.push(<>
